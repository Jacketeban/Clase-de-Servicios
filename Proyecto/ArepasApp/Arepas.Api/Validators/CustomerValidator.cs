    ...
    public class CustomerValidator : AbstractValidator<CustomerDto>
    {
        public CustomerValidator()
        {
            ...
            RuleFor(x => x.UserEmail)
                ...
                .MaximumLength(255).WithMessage("La Longitud Maxima para el Campo UserEmail es de 255 Caracteres");
            ...
            RuleFor(x => x.Address)
                ...
                .MaximumLength(100).WithMessage("La Longitud Maxima para la Direccion del Cliente es de 100 Caracteres");
            ...
            RuleFor(x => x.PhoneNumber)
                 ...
                 .Matches(@"^[0-9-]+$").WithMessage("El Campo de Teléfono Solo Admite Números Separados Por Guiones");
